    ...
    <div class="bg-white shadow rounded-lg max-w-2xl">
        ...
        <div class="mb-6">
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{route('tags.index')}}" class="h-10 inline-flex items-center justify-center px-5 rounded-md border border-gray-300 bg-white text-gray-700 hover:bg-gray-50">
                    Cancel
                </a>
            </div>
        </form>
