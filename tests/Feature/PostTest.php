...
use App\Models\User;  // need to create users
use App\Models\Post; //the thing we are testing
use App\Models\Category; //posts need categories
use App\Models\Tag; // posts can have tags
...
use Tests\TestCase; // Base test class with Laravel testing helpers
use Spatie\Permission\Models\Role; //Import spatie role model (for admin/user roles)
